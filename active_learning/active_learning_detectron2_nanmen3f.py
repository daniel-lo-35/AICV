...
YOUR_TOKEN = "5c5926a8c50b0939168473043764a1e520201a1758df18a4"  # your token of the web platform
YOUR_DATASET_ID = "62b6b05823da0f7db5a83900"  # the id of your dataset on the web platform
DATASET_ROOT = './datasets/20220418_NM3F/images/'
...
print('first 3 iamges in query set:', al_agent.query_set[:3])
...
# images
print('length of query set:', len(al_agent.query_set))
...
cfg.MODEL.WEIGHTS = "./model_RGB_220310.pth"     # Import pretrained weight from previous Steelscape models
...
def predict_and_overlay(model, filename):
    ...
    plt.imsave(filename+'-predict.jpg', out.get_image()[:, :, ::-1])
    plt.axis('off')
    plt.tight_layout()
...
print('length of al set:', len(al_agent.added_set))

# %%
# Let's have a look at the first 5 entries.
print('first 5 images of al set:', al_agent.added_set[:5])
print()
print('Total 100 images to active learning:')
print(al_agent.added_set)
